...
- 源码：[`th12/source/`](th12/source/)

发行版目录包含联机补丁 DLL、启动器、配置文件、校验和及中文用户指南。源码目录保留 CMake 构建文件、补丁 DLL、代理层、启动器、公共模块、测试和研究文档；构建目录、日志和中间产物未上传。

联机补丁加入后，请按作品分别放入 `online/<作品>/`，并在本文件补充版本、兼容性和使用说明。
